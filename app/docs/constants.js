...
const texts = {
    startGameText: `Բարի գալուստ։ Շնորհավորում ենք: Դուք ունեք բացառիկ հնարավորություն\` մասնակցելու All inclusive Armenia ընկերության կողմից կազմակերպված Ineco City Quest-ին։  Ձեզ սպասում են հետաքրքիր ու յուրահատուկ խաղեր, որոնք երբևէ չեք խաղացել։ Ձեզ մոտ կան թղթապանակներ, որոնց մեջ գտնվող իրերը օգնելու են հաղթահարել մեր խաղերը։ Թղթապանակի մեջ գտեք առաջին խաղը, լուծեք առաջադրանքը և քվեսթը շարունակելու համար մեզ ուղարկեք արդյունքում ստացած թիվը. դա Ձեր թիմի կոդն է:`,
    ...
    teamNameSuccess: "Այժմ սկսելու են խաղերը, որոնք խաղալու համար ունեք 2 ժամ ժամանակ։",
